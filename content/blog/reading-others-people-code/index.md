...
subtitle: "Comfortable to Read Other People's Code"
summary: Make it as the journey to the wonderful land, and take your time, don't rush and understand it very well.
tags:
  - programming
categories:
  - programming
...
Please make yourself comfortable to read other people's code, because it is going to be your daily life as a programmer. Make it as the journey to the wonderful land, and take your time, don't rush and understand it very well, ask these question :
Why They write it that way ?
Do they write it with time constraints and pressure ?
How would you implement the feature if you are the person who develops this feature ?
Is it possible to write the unit test ?
...
This skill needs to be developed over time, and this will vary depending on the individual.
I am also not consider my self as a good one, because there are sometime I got confused and say `what the fuck is this ??`. The key point is be patient and write a lot of simple programs with the language that you are working on and you will be surprised when reading other people's code is `fun`, and yes this is one of the most crucial skills you need to have in the industry.
